...
const RULES = [
  ...
  [/^context\/mark\//,                          'Design',         'the mark (SVG sources)'],
  // The rendered mark. Generated by scripts/gen-icons.mjs and committed (rasterizing needs
  // Chromium, so it is off the build path) — design output, not hand-written source.
  [/^packages\/gui\/(assets|build)\//,           'Design',         'the mark (rendered)'],
