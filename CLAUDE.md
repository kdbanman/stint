...
| `acceptance/` | The acceptance-criteria apparatus, split in two: `criteria/` (coverage matrix, JSON schemas, JUDGE rubric, MANUAL runbook, parity matrix — **what must hold**) and `evidence/` (generated **proof those criteria hold** — the tracked text evidence: CLI transcript, judge report, recordings index; all binary evidence lives on the public R2 evidence bucket, never in the repo — issue #256). |
