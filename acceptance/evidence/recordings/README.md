...
**Every GIF name below links to its bucket copy** — the key is derived from the recipe id, so
the link survives every regeneration and points at whatever was uploaded last.
...
| Req id(s) | GIF | What it demonstrates |
|---|---|---|
| §05 R01 | [`05-r01.gif`][05-r01] | Start as the GUI core-entry surface — while a timer runs the Timer view offers only edit-or-stop (no start affordance, issue #51); Stop, then start with details (core's `start` verb itself remains the atomic stop-then-start for `tt`; no Switch verb, issue #34). |
| §05 R02 | [`05-r02.gif`][05-r02] | Stop the running timer from the Timer view; the count-up halts, nothing running. |
| §12 R05 | [`12-r05.gif`][12-r05] | The idle-only Start-with-details form (issue #51): while running the start panel is hidden (only Stop + live-edit); Stop reveals it, the Billable box auto-checks as a client is typed (§05 R07), and submitting opens the new entry (no Switch button). |
| §05 R09 | [`05-r09.gif`][05-r09] | Favorites rail: pin the running timer, list, rename in place, unpin — all via the rail + kebab. |
| §05 R09/R10 | [`favorites-rail.gif`][favorites-rail], [`favorites-rail-empty.gif`][favorites-rail-empty] | One-click Resume starts a favorite (`favorites-rail`); the empty-rail instructional state mentioning `tt fav` (`favorites-rail-empty`). |
| §12 R14 | [`timer-view.gif`][timer-view] | Timer-view tour: live count-up ticking, running state, live-edit strip. |
| §07 R01 | [`07-r01.gif`][07-r01] | Clients-view reference-data CREATE driven end to end (issue #48): + Add client opens the inline New-client field and the committed name lands in the active list; + Add project nests the new project under its client; + Add tag lands in the active tag strip — each over the same IPC its `tt` subcommand uses. |
| §12 R08 | [`12-r08.gif`][12-r08], [`reports-view.gif`][reports-view] | Reports view = saved reports CRUD end-to-end (list → New → build → Save → Run → export CSV/JSON → Edit/regroup → delete); `reports-view` is the tour subset. |
| §12 R11 / §14 | [`settings-view.gif`][settings-view] | Settings panel exposes a control for every §14 setting, including the date-format picker. |
| §19 R03 | [`19-r03.gif`][19-r03] | Software Update: current version row + Check now → queries GitHub Releases → "Update available" verdict + release link. |
| §19 R04 | [`19-r04.gif`][19-r04], [`software-update.gif`][software-update] | Download & guided install: progress bar, numbered steps incl. the one-time Gatekeeper beat, "never touches the database" note, Reveal installer. |
| §20 R04 | [`20-r04.gif`][20-r04] | Backups group: last-backup + verified pill, change retention, restore through the two-step confirm gate. |
| §20 R05 | [`20-r05.gif`][20-r05] | Corruption-recovery notice naming the recovered-from backup + the quarantined file; restore reachable through the confirm gate. |
| §12 R03 | [`12-r03.gif`][12-r03], [`nav-shell.gif`][nav-shell] | Window shell: the sidebar is present in every view and holds a fixed 168px width across resize (`12-r03`); `nav-shell` is the five-view routing tour. |
| §12 R04 | [`12-r04.gif`][12-r04] | Active-Timer placement: the full panel lives in the Timer view while Entries keeps the compact strip of the same running timer. |
| §12 R04 / issue #50 | [`cross-view-freshness.gif`][cross-view-freshness] | Cross-view freshness: after the Entries toolbar's week stepper has been touched (the control that latches the entries query), the Timer view's card still flips idle → running on the spot when Start is pressed (the count-up ticks, no reload) — the regression path the `CROSS_VIEW_FRESHNESS` judge scene gates. |
| §12 R01 | [`12-r01.gif`][12-r01] | Tray popover while running: Stop + Open Stint only, no Switch button. |
| §12 (report.html retired) | [`12-r-report-html.gif`][12-r-report-html] | The standalone sidebar-less `report.html` is retired; the report function folds into the in-shell Reports view (sidebar present throughout). |
...
<!-- The persistent evidence-bucket URLs the names above resolve to. Regenerate the GIFs with
     `npm run record`, then re-upload to these same keys: the links are stable, the bytes are not. -->
[05-r01]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/05-r01.gif
[05-r02]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/05-r02.gif
[05-r05]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/05-r05.gif
[05-r09]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/05-r09.gif
[05-r10]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/05-r10.gif
[06-r03]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/06-r03.gif
[07-r01]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/07-r01.gif
[09-r01]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/09-r01.gif
[12-r-report-html]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r-report-html.gif
[12-r01]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r01.gif
[12-r03]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r03.gif
[12-r04]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r04.gif
[12-r05]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r05.gif
[12-r06]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r06.gif
[12-r07]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r07.gif
[12-r08]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r08.gif
[12-r09]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r09.gif
[12-r10]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r10.gif
[12-r14]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r14.gif
[12-r15]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r15.gif
[12-r16]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/12-r16.gif
...
[favorites-rail-empty]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/favorites-rail-empty.gif
[nav-shell]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/nav-shell.gif
[reports-view]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/reports-view.gif
[running-start-only]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/running-start-only.gif
[settings-view]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/settings-view.gif
[software-update]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/software-update.gif
[timeline-window-settings]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/timeline-window-settings.gif
[timer-view]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/timer-view.gif
[v3]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/v3.gif
[v5]: https://pub-110c939d8c384d6c9e201e5f888c1288.r2.dev/acceptance/evidence/recordings/v5.gif
